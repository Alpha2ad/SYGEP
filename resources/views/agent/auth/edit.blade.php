            ...
            <div class="row clearfix">
                ...
                <form method="POST" action=" {{route('admin.agents.update',[$agent->id])}}">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                        <div class="card">
                            <div class="header bg-teal">
                                <span class="card-title">Modification des informations de L'agent</span>
                                <ul class="header-dropdown m-r--5">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            ...
                                            {{-- <li> <a href="{{route('agent.roles')}}" class="bg-cyan text-white"><i class="material-icons">add</i>Nouveau Role</a></li> --}}
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                            <div class="body">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="form-line">
                                        <input id="name" type="text" value="{{ $agent->name }}" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" placeholder="Nom" required autofocus>
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input id="email" type="email" value="{{ $agent->email }}" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" placeholder="Addresse E-Mail" required>
                ...
                <div class="body">
                    ...
                    <select name="agence_id" id="agence_id" class=" {{ $errors->has('agence_id') ? ' is-invalid' : '' }}" data-live-search="true" >
                        ...
                        <option value="{{ $agence->id }}"
                            @if (in_array($agence->id,$agent->agence->pluck('id')->toArray()))
                            selected
                            @endif >{{ $agence->name }}
                        </option>
                        @endforeach
                    ...
                    <br>
                    <a href="{{ route('admin.agents.index') }}"  class="btn btn-warning m-t-15 waves-effect"><i class="material-icons">reply</i>Retour</a>
