...
<section class="">
    ...
    <form id="sign_in" method="POST" action="{{ route('agent.login') }}" aria-label="{{ __('agent Login') }}" novalidate="novalidate">
                    @csrf
                    ...
                    <div class="row m-t-15 m-b--20">
                        ...
                        <div class="col-xs-6 align-right">
                            <a href="{{ route('agent.password.request') }}">Mot de Passe Oublié?</a>
                        </div>
                    </div>
                </form>
