                                ...
                                <tbody>
                                    ...
                                    <td> <ul class="header-dropdown m-r--5">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu pull-right">
                                                <li><a href="{{ route('admin.agents.show', $agent->id) }}" class="mr-3 bg-deep-purple text-white"><i class="material-icons">visibility</i>Detail</a></li>
                                                <li role="separator" class="divider"></li>
                                                <li><a href="{{ route('admin.agents.edit', $agent->id) }} " class="mr-3 bg-cyan text-white" ><i class="material-icons">edit</i>Modification</a></li>
                                                <li role="separator" class="divider"></li>
                                            <li>
                                                @if ($agent->status == true)
                                                <form method="POST" id="activation-{{ $agent->id }} " action="{{ route('admin.agent.approuve', [$agent->id]) }}" style="display: none;">
                                                        @csrf
                                                        @method('PUT')
                                                    </form>
                                                    ...
                                                    @else
                                                    <form method="POST" id="desactivation-form-{{ $agent->id }} " action="{{ route('admin.agent.approuve', [$agent->id]) }}" style="display: none;">
                                                            @csrf
                                                            @method('PUT')
                                                        </form>
                                         ...
                                         <li role="separator" class="divider"></li>
                                         <li>
                                                <form method="POST" id="delete-form-{{ $agent->id }} " action="{{ route('admin.agents.destroy', [$agent->id]) }}" style="display: none;">
                                                 @csrf
                                                 @method('DELETE')
                                             </form>
