...
<section class="content">
  <div class="container-fluid">
    ...
    <!-- Vertical Layout -->
    <form method="POST" action="{{ route('agentTuteurs.update', $tuteur->id) }}" enctype="multipart/form-data">
      @csrf
      @method('PUT')
            ...
            <div class="body">
              <div class=" row">
                <div class="input-group form-float">
                  ...
                  <div class="form-line">
                    <input type="text" class="form-control date" value="{{$tuteur->nom }}" name="nom" required>
                  </div>
                </div>
                <div class="input-group">
                  ...
                  <div class="form-line">
                    <input type="text" class="form-control mobile-phone-number" value="{{$tuteur->telephone }}" required name="telephone">
                  </div>
                </div>
                <div class="input-group">
                  <span class="input-group-addon">
                  ...
                  <div class="form-line">
                    <input type="text" class="form-control email" value="{{$tuteur->email }}" name="email" required>
                  </div>
                </div>
                <div class="form-line">
                  <textarea rows="4" class="form-control no-resize" placeholder="Description..." name="description">{{$tuteur->description }}</textarea>
                </div>
              </div>
