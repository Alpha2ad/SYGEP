        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header bg-teal">
                        <h2>
                           {{$logement->hebergement->nom}} / {{$logement->nom }} / <strong class=" badge bg-white">{{$logement->pelerins->count()}}/{{$logement->nombre_place }}</strong> Places
                        ...
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li><a href="{{route('logements.index')}}" class=" waves-effect waves-block bg-teal"><i class=" material-icons">reply</i> Retour</a></li>
                        ...
                        <div class="table-responsive">
                          <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                             ...
                             @foreach($logement->pelerins as $key=> $pelerin)
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li class="white"><a href="{{route('pelerins.show',$pelerin->id)}} " class="waves-effect waves-block bg-teal"><i class=" material-icons">visibility</i> Detail</a></li>
                                    <li><a href="javascript:void(0);" class=" waves-effect waves-block">Something else here</a></li>
                                </ul>
                            </li>
                        </ul>
