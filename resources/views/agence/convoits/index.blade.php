...
<section class="content">
  <div class="container-fluid">
    <div class="block-header">
      ...
      <a class=" btn waves-effect  bg-teal"  href=" {{ route('convoits.create') }} "><i class="material-icons">add</i><span>Ajouter un convoit</span></a>
    </div>
              ...
              <div class="body">
               ...
               <td class=""> <ul class="header-dropdown m-r--5 ">
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu pull-right ">
                    <li class="white"><a href="{{ route('convoits.show', $convoit->id) }}" class="btn waves-effect white"><i class="material-icons">visibility</i>Detail</a></li>
                    <li><a href="{{ route('convoits.edit', $convoit->id) }}" class="btn waves-effect white-text"><i class="material-icons">edit</i>Modification</a></li>
                    <li>
                    </li>
                    <li>
                     <form method="post" id="delete-form-{{ $convoit->id }} " action="{{ route('convoits.destroy', $convoit->id) }}" style="display: none;">
                      @csrf
                      @method('DELETE')
                    </form>
