...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="row clearfix">
                <!-- Task Info -->
                <form method="POST" action="{{ route('bagages.update', $bagage->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                @foreach($bagage->agence->pelerins as $key=>$pelerin)
                                <option value="{{ $pelerin->id }}" {{$bagage->pelerin->id = $pelerin ? 'selected': ''}}>
