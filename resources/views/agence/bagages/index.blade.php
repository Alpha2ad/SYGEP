...
<section class="content">
  <div class="container-fluid">
    <div class="block-header">
      ...
      <a class=" btn bg-teal waves-effect "  href=" {{ route('bagages.create') }} "><i class="material-icons">add</i><span>Ajouter un Colis</span></a>
    </div>
    {{-- formulaire d'ajout de bagages --}}
    <form action="{{route('bagages.store') }} " method="POST" enctype="multipart/form-data">
      @csrf
              ...
              <div class="body">
               ...
               <td class=""> <ul class="header-dropdown m-r--5 ">
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu pull-right ">
                    <li class="white"><a href="{{ route('bagages.show', $bagage->id) }}" class="btn waves-effect white"><i class="material-icons">visibility</i>Detail</a></li>
                    <li><a href="{{ route('bagages.edit', $bagage->id) }}" class="btn waves-effect white-text"><i class="material-icons">edit</i>Modification</a></li>
                    <li>
                    </li>
                    <li>
                     <form method="post" id="delete-form-{{ $bagage->id }} " action="{{ route('bagages.destroy', $bagage->id) }}" style="display: none;">
                      @csrf
                      @method('DELETE')
                    </form>
