...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="row clearfix">
                <!-- Task Info -->
                <form method="POST" action="{{ route('hebergements.update', $hebergement->id) }}">
                    @csrf
                    @method('PUT')
                                ...
                                <ul class="header-dropdown m-r--5">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            ...
                                            <li> <a href="{{route('hebergements.index')}}" class="bg-teal text-white"><i class="material-icons">visibility</i>Liste des bagages</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                            <div class="body">
                                ...
                                <div class="input-group form-float">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <div class="form-line">
                                          <input type="" min="0" class="form-control " placeholder="Nombre d'etages'" name="nombre_etage"  value="{{$hebergement->nombre_etage}} ">
                                      </div>
                                  </div>
                                  <div class="input-group">
                                        {{-- <span class="input-group-addon">
                                      ...
                                      <div class="form-line">
                                          <input type="" min="0" class="form-control " placeholder="Nombre de chambre" name="nombre_chambre"  value="{{$hebergement->nombre_chambre}} ">
                                      </div>
                                  </div>
                                  <div class="input-group">
                                        {{-- <span class="input-group-addon">
