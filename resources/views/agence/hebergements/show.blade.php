                        ...
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li><a href="{{route('hebergements.index')}}" class=" waves-effect waves-block bg-teal"><i class=" material-icons">reply</i> Retour</a></li>
                                    <li><a href="{{route('logements.create')}}" class=" waves-effect waves-block  bg-amber"><i class=" material-icons">add</i>Logement</a></li>
                        ...
                        <div class="table-responsive">
                          <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li class="white"><a href="{{route('logements.show',$logement->id)}} " class="btn waves-effect waves-block "><i class=" material-icons">visibility</i> Detail</a></li>
                                    <li class="white"><a href="{{route('logements.edit',$logement->id)}} " class="btn waves-effect waves-block "><i class=" material-icons">edit</i> Modifier</a></li>
                                </ul>
                            </li>
                        </ul>
                             </td>
