    ...
    <section class="">
       ...
       <form method="POST" action="{{ route('agence.register') }}">
    @csrf
    <div class="body">
    ...
    <div class="row m-t-15 m-b--20">
        ...
        <div class="col-xs-6 align-right">
            <a href="{{ route('agence.login') }}">J'ai un compte</a>
        </div>
    </div>
    </div>
</div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                        <div class="card">
                            <div class="header bg-teal">
                                <span class="card-title">Ajout d'une nouvelle <strong>Agence</strong></span>
                                <ul class="header-dropdown m-r--5">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            ...
                                            <li> <a href="{{route('admin.agences.index')}}" class="bg-cyan text-white"><i class="material-icons">visibility</i>Liste des Agences</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
