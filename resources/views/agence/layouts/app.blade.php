...
<link rel="stylesheet" href="{{ asset('backend/assets/plugins/bootstrap-select/css/bootstrap-select.css') }}">
 ...
 <!-- agenceBSB Themes. You can choose a theme from css/themes instead of get all themes -->
...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand title" href="{{route('agence.dashboard')}}">{SYGEP} SYSTEME DE GESTION DU PELERINAGE</a>
        </div>
...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info">
            ...
            <div class="info-container">
                <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> {{ auth('agence')->user()->name }} </div>
                <div class="email">{{ auth('agence')->user()->email }} </div>
                <div class="btn-group user-helper-dropdown">
                    ...
                    <ul class="dropdown-menu pull-right ">
                        ...
                        {{-- <li role="separator" class="divider"></li> --}}
                        <li class="bg-red text-white"><a class="dropdown-item font-italic font-bold" href="/agence/logout" onclick="event.preventDefault();
    ...
    <div class="menu">
        <ul class="list">
            ...
            <form id="logout-form" action="{{ route('agence.logout') }}" method="POST" style="display: none;">
                @csrf
            </form>
            <li class="{{ Request::is('agence') ? 'active': '' }}">
                <a href="{{ route('agence.dashboard') }}">
                    <i class="material-icons">dashboard</i>
                    <span>Tableau de bord</span>
                </a>
             </li>
             <li class="{{ Request::is('agence/tuteurs*') ? 'active': '' }}">
                <a href="{{ route('tuteurs.index') }}">
                    <i class="material-icons">person_add</i>
                    <span>Tuteurs </span>
                </a>
            </li>
            <li class="{{ Request::is('agence/pelerins*') ? 'active': '' }}">
                 <a href="{{ route('pelerins.index') }}">
                    <i class="material-icons">flag</i>
                    <span>Pelerin</span>
                </a>
            </li>
            <li class="{{ Request::is('agence/convoits*') ? 'active': '' }}">
                        <a href="{{ route('convoits.index') }}">
                            <i class="material-icons">flight</i>
                            <span>Convoits</span>
                        </a>
                    </li>
            <li class="{{ Request::is('agence/bagages*') ? 'active': '' }}">
                        <a href="{{ route('bagages.index') }}">
                            <i class="material-icons">business</i>
                            <span>Bagages</span>
                        </a>
                    </li>
            <li class="{{ Request::is('agence/paiements*') ? 'active': '' }}">
                        <a href="{{ route('paiements.index') }}">
                            <i class="material-icons">money</i>
                            <span>Paiements </span>
                        </a>
                    </li>
                    <li class="{{ Request::is('agence/hebergements*') ? 'active': '' }}">
                        <a href="{{ route('hebergements.index') }}">
                            <i class="material-icons">location_city</i>
                            <span>Hebergements</span>
                        </a>
                    </li>
                    <li class="{{ Request::is('agence/logements*') ? 'active': '' }}">
 ...
 --}}
            <li>
                ...
                <ul class="ml-menu">
                    <li class="{{ Request::is('agence/agenceAgent*') ? 'active': '' }}">
                        <a href="{{ route('agenceAgent.index') }}">
                           <i class="material-icons">group</i>
                           <span>Agent</span>
                       </a>
                   </li>
                   <li class="{{ Request::is('agence/agenceComptable*') ? 'active': '' }}">
                    <a href="{{ route('agenceComptable.index') }}">
                       <i class="material-icons">group</i>
