...
<section class="content">
  <div class="container-fluid">
    ...
    <form action="{{route('admin.tuteurs.store')}} " method="post">
      @csrf
    ...
    <!-- Vertical Layout -->
    <form method="POST" action="{{ route('admin.pelerins.update', $pelerin->id) }}" enctype="multipart/form-data">
      @csrf
      @method('PUT')
      <div class="row clearfix">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
          <div class="card">
            ...
            <div class="body">
              <label for="agence" class="form-label" >Selectionnez le type </label>
              ...
              <label for="agence" class="form-label" >Selectionnez l'agence</label>
              <select class="form-control show-tick" id="agence" name="agence"  data-live-search="true" >
                ...
                <option value="{{ $agence->id }}" {{$pelerin->agence->id = $agence ? 'selected': ''}}>{{ $agence->name }}</option>
                @endforeach
              </select>
              <br>
              ...
              <br>
              <a href="{{ route('admin.pelerins.index') }}"  class="btn btn-warning m-t-15 waves-effect"><i class="material-icons">reply</i>Retour</a>
