...
<section class="content">
  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    <div class="button-demo">
            <a href="{{ route('admin.pelerins.create') }}" type="button" class="btn bg-teal waves-effect"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;"><i class=" material-icons">add</i> Ajouter</font></font></a>
                    ...
                    <tbody>
                     ...
                     <td class=""> <ul class="header-dropdown m-r--5 ">
                       <li class="dropdown">
                         ...
                         <ul class="dropdown-menu pull-right ">
                           <li class="white"><a href="{{ route('admin.pelerins.show', $pelerin->id) }}" class="btn waves-effect white"><i class="material-icons">visibility</i>Detail</a></li>
                           <li><a href="{{ route('admin.pelerins.edit', $pelerin->id) }}" class="btn waves-effect white-text"><i class="material-icons">edit</i>Modification</a></li>
                           <li>
                           </li>
                           <li>
