...
<section class="content">
  <div class="container-fluid">
    ...
    <div class="block-header">
     ...
     <a href="{{ route('admin.paiements.index') }}  " class="btn btn-warning waves-effect"> <i class="material-icons" rel="tooltip" title="Retour a la liste de paiements">reply</i> Retour</a>
   </div>
      ...
      <div class="card">
        <div class="header bg-teal">
          <h2>
            ...
            {{-- <small>Posté par: <strong><a href="" class="text-uppercase"></a>{{ $post->admin->name }}   </strong> Date: {{ $post->created_at->toDateString() }} </small> --}}
          </h2>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu pull-right">
                <li><a href="javascript:void(0);">
                  ...
                  {{-- <form method="POST" action="{{ route('admin.post.approuve' ,$post->id) }}"
