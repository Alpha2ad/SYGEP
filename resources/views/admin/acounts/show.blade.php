...
<section class="content">
  <div class="container-fluid">
    <div class="block-header">
      ...
      <a class=" btn bg-teal waves-effect "  href=" {{ route('admin.paiements.create') }} "><i class="material-icons">add</i><span>Effectuer un paiement</span></a>
    </div>
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
          <div class="header bg-teal card">
            <h2 >
              Liste des paiements
              <span class="badge bg-white">{{ $acount->paiements->count()}}</span>
              <small class=" bold">Montant Total: {{$acount->paiements->sum('montant')}} GNF</small>
            </h2>
            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                ...
                <tbody>
                 ...
                 @foreach($acount->paiements as $key=> $paiement)
                 ...
                 <td class=""> <ul class="header-dropdown m-r--5 ">
                  <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right ">
                      <li class="white"><a href="{{ route('admin.paiements.show', $paiement->id) }}" class="btn waves-effect white"><i class="material-icons">visibility</i>Detail</a></li>
                      <li><a href="{{ route('admin.paiements.edit', $paiement->id) }}" class="btn waves-effect white-text"><i class="material-icons">edit</i>Modification</a></li>
                      <li>
                      </li>
                      <li>
                       <form method="post" id="delete-form-{{ $paiement->id }} " action="{{ route('admin.paiements.destroy', $paiement->id) }}" style="display: none;">
                        @csrf
                        @method('DELETE')
                      </form>
