...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="row clearfix">
                <!-- Task Info -->
                <form method="POST" action="{{ route('admin.logements.store') }}">
                    @csrf
                                ...
                                <ul class="header-dropdown m-r--5">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            ...
                                            <li> <a href="{{route('admin.logements.index')}}" class="bg-teal text-white"><i class="material-icons">visibility</i>Liste des logements</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                            <div class="body">
                                ...
                                <div class="input-group form-float">
                                  ...
                                  <div class="input-group">
                                      ...
                                      <div class="form-line">
                                          <input type="number" min="0" class="form-control " placeholder="Nombre de place" name="nombre_place" required>
                                      </div>
                                  </div><br>
                                  <div class="form-line">
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <select class="form-control show-tick" id="pelerin" name="pelerins[]" multiple data-live-search="true" >
                                    ...
                                    <option value="{{ $pelerin->id }}">{{ $pelerin->nom }} {{ $pelerin->prenom }} ({{ $pelerin->id_pelerin }})</option>
                                   @endforeach
                               </select>
                               <br> <br>
