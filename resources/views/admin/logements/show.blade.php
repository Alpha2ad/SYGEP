                        ...
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu pull-right">
                                    <li><a href="{{route('admin.logements.index')}}" class=" waves-effect waves-block bg-teal"><i class=" material-icons">reply</i> Retour</a></li>
                          ...
                          <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                             ...
                             <tr>
                              ...
                              <td>
                                <a href="{{route('admin.pelerins.show',$pelerin->id)}} " class=" btn waves-effect bg-teal"><i class=" material-icons">visibility</i></a>
                             </td>
