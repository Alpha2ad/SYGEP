...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="row clearfix">
                <!-- Task Info -->
                <form method="POST" action="{{ route('admin.hebergements.update', $hebergement->id) }}">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="card">
                                ...
                                <ul class="header-dropdown m-r--5">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            ...
                                            <li> <a href="{{route('admin.hebergements.index')}}" class="bg-teal text-white"><i class="material-icons">visibility</i>Liste des bagages</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                            <div class="body">
                                ...
                                <div class="input-group form-float">
                                      ...
                                      <div class="form-line">
                                          <input type="text"  class="form-control " placeholder="Nom" name="nom" required value="{{$hebergement->nom}} ">
                                      </div>
                                  </div>
                                  <div class="input-group form-float">
                                        {{-- <span class="input-group-addon">
                                      ...
                                      <div class="form-line">
                                          <input type="text"  class="form-control " placeholder="Adresse" name="adresse" required value="{{$hebergement->adresse}} ">
                                      </div>
                                  </div>
                                  <div class="input-group">
                                      ...
                                      <div class="form-line">
                                          <input type="number" min="0" class="form-control " placeholder="Nombre d'etages'" name="nombre_etage"  value="{{$hebergement->nombre_etage}} ">
                                      </div>
                                  </div>
                                  <div class="input-group">
                                        {{-- <span class="input-group-addon">
                                      ...
                                      <div class="form-line">
                                          <input type="number" min="0" class="form-control " placeholder="Nombre de chambre" name="nombre_chambre"  value="{{$hebergement->nombre_chambre}} ">
                                      </div>
                                  </div>
                                  <div class="input-group">
                                        {{-- <span class="input-group-addon">
                                      ...
                                      <div class="form-line">
                                          <input type="telephone"  class="form-control " placeholder="Numero de telephone" name="telephone" required value="{{$hebergement->telephone}} ">
                                      </div>
                                  </div>
                              </div>
                      ...
                      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <label for="role_id" class="form-label" >Selectionnez une agence</label>
                               ...
                               <br>
                               <div class="form-line">
                                <textarea rows="4" class="form-control no-resize" placeholder="Description..." name="description">{{$hebergement->description}} </textarea>
                            </div>
