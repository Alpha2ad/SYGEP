...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            ...
            <div class="row clearfix">
                <!-- Task Info -->
                <form method="POST" action="{{ route('admin.hebergements.store') }}">
                    @csrf
                                ...
                                <ul class="header-dropdown m-r--5">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            ...
                                            <li> <a href="{{route('admin.hebergements.index')}}" class="bg-cyan text-white"><i class="material-icons">visibility</i>Liste des bagages</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
