...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand small" href="#">{SYGEP} SYSTEME DE GESTION DU PELERINAGE</a>
        </div>
...
<section>
            ...
            <div class="info-container">
                ...
                <div class="btn-group user-helper-dropdown">
                    ...
                    <ul class="dropdown-menu pull-right">
                        ...
                        @admin('super')
                        <li><a class="dropdown-item" href="{{ route('admin.show') }}"><i class="material-icons">assignment_ind</i>{{ ucfirst(config('multiauth.prefix')) }}</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a class="dropdown-item" href="{{ route('admin.roles') }}"><i class="material-icons">assignment_late</i>Roles</a></li>
                        @endadmin
                        <li role="separator" class="divider"></li>
                        <li><a class="dropdown-item" href="/admin/logout" onclick="event.preventDefault();
    ...
    <div class="menu">
        <ul class="list">
            <li class="header bg-teal">MENU DE NAVIGATION</li>
            ...
            <li>
                <a href="javascript:void(0);" class="menu-toggle">
                    <i class="material-icons">settings</i>
                    <span class="dropdown-item {{ Request::is('admin/agences*') ? 'active': '' }}">Compte</span>
                </a>
                <ul class="ml-menu">
                    @admin('super')
                    <li class="{{ Request::is('admin/agences*') ? 'active': '' }}">
                        <a class="dropdown-item " href="{{ route('admin.agences.index') }}">
                            <i class="material-icons">assignment_ind</i>
                            <span>Agences</span>
                        </a>
                    </li>
                    <li class="{{ Request::is('admin/agents*') ? 'active': '' }}">
                        <a class="dropdown-item " href="{{ route('admin.agents.index') }}">
                            <i class="material-icons">assignment_ind</i>
                            <span>Agents</span>
                        </a>
                    </li>
                    <li class="{{ Request::is('admin/medecins*') ? 'active': '' }}">
                        <a class="dropdown-item " href="{{ route('admin.medecins.index') }}">
                            <i class="material-icons">assignment_ind</i>
                            <span>Medecins</span>
                        </a>
                    </li>
                    <li class="{{ Request::is('admin/comptables*') ? 'active': '' }}">
                        <a class="dropdown-item " href="{{ route('admin.comptables.index') }}">
                            <i class="material-icons">assignment_ind</i>
            ...
            <li class="{{ Request::is('admin/tuteurs*') ? 'active': '' }}">
                <a href="{{ route('admin.tuteurs.index') }}">
                    <i class="material-icons">person_add</i>
                    <span>Tuteurs </span>
                </a>
            </li>
            <li class="{{ Request::is('admin/pelerins*') ? 'active': '' }}">
                        <a href="{{ route('admin.pelerins.index') }}">
                    ...
                    <li class="{{ Request::is('admin/convoits*') ? 'active': '' }}">
                        <a href="{{ route('admin.convoits.index') }}">
                            <i class="material-icons">flight</i>
                            <span>Convoits</span>
                        </a>
                    </li>
                     <li class="{{ Request::is('admin/bagages*') ? 'active': '' }}">
                        <a href="{{ route('admin.bagages.index') }}">
                            <i class="material-icons">business</i>
                            <span>Bagages</span>
                        </a>
                    </li>
                    <li class="{{ Request::is('admin/hebergements*') ? 'active': '' }}">
                        <a href="{{ route('admin.hebergements.index') }}">
                            <i class="material-icons">location_city</i>
                            <span>Hebergements</span>
                        </a>
                    </li>
                    <li class="{{ Request::is('admin/logements*') ? 'active': '' }}">
                        <a href="{{ route('admin.logements.index') }}">
                            <i class="material-icons">home</i>
                            <span>Logements</span>
                        </a>
                    </li>
                    <li class="{{ Request::is('admin/acounts*') ? 'active': '' }}">
                        <a href="{{ route('admin.acounts.index') }}">
                            <i class="material-icons">credit_card</i>
                            <span>Acounts </span>
                        </a>
                    </li>
                    <li class="{{ Request::is('admin/paiements*') ? 'active': '' }}">
                    ...
                    <li class="{{ Request::is('admin/produits*') ? 'active': '' }}">
