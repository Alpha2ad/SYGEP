...
@section('title', 'Modification du nom de role')
                        ...
                        <div class="body">
                            <form method="POST" action="{{ route('admin.role.update', $role->id) }}">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="form-line">
                                        <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ $role->name }}" placeholder="Nom" required autofocus>
