    ...
    <div class="row m-t-15 m-b--20">
        ...
        <div class="col-xs-6 align-right">
            <a href="{{ route('medecin.login') }}">J'ai un compte</a>
        </div>
    </div>
    </div>
</div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
                        <div class="card">
                            <div class="header bg-teal">
                                <span class="card-title">Ajout d'une nouvelle <strong>medecin</strong></span>
                                <ul class="header-dropdown m-r--5">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            ...
                                            <li> <a href="{{route('admin.medecins.index')}}" class="bg-cyan text-white"><i class="material-icons">visibility</i>Liste des medecins</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                {{-- <a href="{{ route('medecin.show') }}"  class="btn btn-warning m-t-15 waves-effect"><i class="material-icons">reply</i>Retour</a> --}}
