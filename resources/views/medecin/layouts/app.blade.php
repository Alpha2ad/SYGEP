...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand title" href="{{ route('medecin.dashboard') }}">{SYGEP} SYSTEME DE GESTION DU PELERINAGE</a>
        </div>
...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info">
            ...
            <div class="info-container">
                <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> {{ auth('medecin')->user()->name }} </div>
                <div class="email">{{ auth('medecin')->user()->email }} </div>
                <div class="btn-group user-helper-dropdown">
                    ...
                    <ul class="dropdown-menu pull-right ">
                        ...
                        {{-- <li role="separator" class="divider"></li> --}}
                        <li class=" white-text "><a class="dropdown-item font-italic font-bold" href="/medecin/logout" onclick="event.preventDefault();
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li class="{{ Request::is('medecin') ? 'active': '' }}">
