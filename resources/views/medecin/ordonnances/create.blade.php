...
<section class="content">
  <div class="container-fluid">
    <form method="POST" action="{{ route('medecinOrdonnances.store') }}" enctype="multipart/form-data">
      @csrf
      ...
      <button type="button" class="btn btn-danger waves-effect"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">DANGER</font></font></button> --}}
          ...
          <div class="card">
            ...
            <select class="form-control show-tick" required  data-live-search="true" id="pelerin" name="pelerin">
