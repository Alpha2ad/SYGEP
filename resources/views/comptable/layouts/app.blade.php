...
<link rel="stylesheet" href="{{ asset('backend/assets/plugins/bootstrap-select/css/bootstrap-select.css') }}">
 ...
 <!-- comptableBSB Themes. You can choose a theme from css/themes instead of get all themes -->
...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info">
            ...
            <div class="info-container">
                <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> {{ auth('comptable')->user()->name }} </div>
                <div class="email">{{ auth('comptable')->user()->email }} </div>
                <div class="btn-group user-helper-dropdown">
                    ...
                    <ul class="dropdown-menu pull-right ">
                        ...
                        {{-- <li role="separator" class="divider"></li> --}}
                        <li class="bg-red text-white"><a class="dropdown-item font-italic font-bold" href="/comptable/logout" onclick="event.preventDefault();
    ...
    <div class="menu">
        <ul class="list">
            ...
            <form id="logout-form" action="{{ route('comptable.logout') }}" method="POST" style="display: none;">
                @csrf
            </form>
            <li class="{{ Request::is('comptable/home*') ? 'active': '' }}">
                {{-- <a href="{{ route('comptable.home') }}"> --}}
                    <i class="material-icons">dashboard</i>
                    <span>Tableau de bord</span>
                </a>
             </li>
            <li class="{{ Request::is('comptable/pelerins*') ? 'active': '' }}">
                 <a href="{{ route('pelerins.index') }}">
                    <i class="material-icons">flag</i>
                    <span>Pelerin</span>
                </a>
            </li>
            {{-- <li class="{{ Request::is('comptable/convoits*') ? 'active': '' }}">
