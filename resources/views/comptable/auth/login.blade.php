...
<section class="">
    ...
    <form id="sign_in" method="POST" action="{{ route('comptable.login') }}" aria-label="{{ __('comptable Login') }}" novalidate="novalidate">
                    @csrf
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input id="password" type="password" placeholder="Mot de passe" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required aria-required="true">
                    ...
                    <div class="row m-t-15 m-b--20">
                        ...
                        <div class="col-xs-6 align-right">
                            <a href="{{ route('comptable.password.request') }}">Mot de Passe Oublié?</a>
                        </div>
                    </div>
                </form>
